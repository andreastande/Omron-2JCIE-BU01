...
class DataParser(object):
    ...
    FIELDS = {
        ...
        0x503E: [
            ("storage",         "Storage total page",      "UInt16",    1,    ""),
            ("eq_or_vib_count"  "Eq or Vib Count",         "UInt32",    1,    ""),
            ("time_counter",    "Time Counter",            "UInt64",    1,    ""),
            ("eq_flag",         "Earthquake flag",         "UInt8",     1,    ""),
            ("si_acc",          "SI calc acceleration",    "UInt8",     1,    ""),
            ("res_1",           "Reserved nr. 1",          "UInt8",     1,    ""),
            ("page_nr",         "Page Number",             "UInt8",     1,    ""),
            ("si",              "SI value",                "UInt16",    10,   "kine"),
            ("pga",             "PGA",                     "UInt16",    10,   "gal"),
            ("seismic_int",     "Seismic intensity",       "UInt16",    1000, ""),
            ("max_acc_x",       "Max Acceleration (X)",    "SInt16",    10,   "gal"),
            ("max_acc_y",       "Max Acceleration (Y)",    "SInt16",    10,   "gal"),
            ("max_acc_z",       "Max Acceleration (Z)",    "SInt16",    10,   "gal"),
            ("temperature",     "Temperature",             "SInt16",    100,  "degC"),
            ...
            ("thi",             "Discomfort index; THI",   "SInt16",    100,  ""),
            ("wbgt",            "Heat stroke; WBGT",       "SInt16",    100,  "degC"),
            ("res_2",           "Reserved nr. 2",          "UInt8",     1,    ""),
            ("res_3",           "Reserved nr. 3",          "UInt8",     1,    ""),
            ("acc_x",           "Acceleration (X-axis)",   "SInt16",    10,   "gal"),
            ("acc_y",           "Acceleration (Y-axis)",   "SInt16",    10,   "gal"),
            ("acc_z",           "Acceleration (Z-axis)",   "SInt16",    10,   "gal")
        ],
...
#        0x03:   "scan_active",
        ...
        0X503E: "acceleration_memory_header",
        0x5111: "led_setting",
